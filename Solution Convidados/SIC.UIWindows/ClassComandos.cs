...
namespace EVENTOS.UIWindows
{
    class ClassComandos
    {
        ...
        public class Comando
        {
            ...
            public static string DoMostraSerialHD(string parametro)
            {
                /* 
            ...
            public static string DoMostraVersaoframework()
            {
            ...
            public static string DoDataExtenso(string wdata)
            {
                try
                {
                    DateTime data;
            ...
            public string DoValorExtenso(string wvalor)
            {
            ...
            public static byte[] DoImagemParaByte(System.Drawing.Image imageToConvert, ImageFormat formatOfImage)
            {
                byte[] retorno;
                try
                {
            ...
            public static string DoCronometro(string param, DateTime tempo)
            {
                /*
            ...
            /// <param name="texto">Aviso</param>
            /// <returns>Aviso</returns>
            /*public static void doChamaForm(Form nome,string titulo)
            {
                nome frm = new nome();
            ...
            /// <summary>
            /// Autor: Marcos
            /// Interação com o usuário, principalemente acessos retrsitos
            /// </summary> 
            /// <param name="texto">Aviso</param>
            /// <returns>Aviso</returns>
            public static void cmdAcessoNegado()
            {
                FormAviso frm = new FormAviso();
                frm.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
                frm.BackColor = System.Drawing.Color.Red;
                frm.Text = "Acesso Negado...";
                frm.ShowDialog();
            }
            ...
            */
            ...
            public static string DoAssemblyDescription
            {
                get
                {
