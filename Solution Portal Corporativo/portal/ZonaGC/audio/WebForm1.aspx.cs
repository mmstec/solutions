           ...
           if (e.Row.RowType == DataControlRowType.DataRow)
             {
                ...
                /*lbl1.Text +=" <object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='150' height='20'";
                lbl1.Text +="  codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab'>";
                lbl1.Text +="  <param name='movie' value='singlemp3player.swf?file="+e.Row.Cells[0].Text+"&autoStart=false&backColor=000000&frontColor=ffffff&songVolume=90' />";
                lbl1.Text +="  <param name='wmode' value='transparent' />'";
                lbl1.Text +="  <embed wmode='transparent' width='150' height='20' src='singlemp3player.swf?showDownload=false'";
                lbl1.Text +="  type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer' />";
                lbl1.Text +="</object>";
                e.Row.Cells[iGraph].Controls.Add(lbl1);
                */

                lbl2.Text +=" <script type='text/javascript' src='swfobject.js'></script>";
                lbl2.Text += " <div id='media" + e.Row.Cells[0].Text + "'>Não foi possível carregar o tocador.</div>";

                lbl2.Text +=" <script type='text/javascript'>";
                lbl2.Text +="   var so = new SWFObject('player.swf','ply','350','24','9','#000000');";
                lbl2.Text +="   so.addParam('allowfullscreen','true');";
                lbl2.Text +="   so.addParam('allowscriptaccess','always');";
                lbl2.Text +="   so.addParam('wmode','opaque');";
                lbl2.Text += "  so.addVariable('file','" + e.Row.Cells[0].Text + "');";
                lbl2.Text +="   so.addVariable('duration','33');";
                lbl2.Text += "   so.write('media" + e.Row.Cells[0].Text + "');";
                lbl2.Text += " </script>";
                e.Row.Cells[iGraph].Controls.Add(lbl2);

                img1.ImageUrl = "~/imagens/16x16/sound.png";
