...
namespace eventos.UIWindows
{
    public partial class FormLogin : Form
    {
        ...
        public FormLogin(int pTentativa)
        {
            ...
            label3.Text = tentativa.ToString() + "/3";
        }
        ...
        private void buttonEntrar_Click(object sender, EventArgs e)
        {
            ...
            string filtro = "select UsuariosId, UsuariosNome, UsuariosLogin, UsuariosSenha, UsuariosPerfil from usuarios where Usuarios.UsuariosLogin = '" + textBoxUsuario.Text.Trim() + "' and Usuarios.UsuariosSenha = '" + usuarioSenhaEncrypt.Trim() + "' ";
