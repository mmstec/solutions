...
namespace eventos.UIWindows.xCONVIDADOS
{
    public partial class FormListar : Form
    {
        ...
        private void FormListar_Load(object sender, EventArgs e)
        {
            ...
            Filtrar("SELECT * FROM convidados WHERE " + campo + " LIKE '" + toolStripTextBox2.Text + "%' " + filtro);
        }
        ...
        private void toolStripComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (toolStripComboBoxProcurar.SelectedIndex)
            {
                case 0:
                    ...
                    toolStripTextBox2.MaxLength = 255;
                    break;
                case 1:
                    campo = "convidadosCartao";
                    toolStripTextBox2.MaxLength = 8;
                    break;
            }
        }
        ...
        private void todosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            AusentesToolStripMenuItem.Checked = false;
            PresentesToolStripMenuItem.Checked = false;
        ...
        private void AusentesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            AusentesToolStripMenuItem.Checked = true;
            PresentesToolStripMenuItem.Checked = false;
            toolStripExibir.Text = "Exibir Ausentes";
            Filtrar("SELECT * FROM convidados WHERE " + campo + " LIKE '" + toolStripTextBox2.Text + "%' " + filtro);
        }

        private void PresentesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            filtro = " AND convidadosPresenca LIKE 'PRESENTE%'";
            TodosToolStripMenuItem.Checked = false;
            AusentesToolStripMenuItem.Checked = false;
            PresentesToolStripMenuItem.Checked = true;
            toolStripExibir.Text = "Exibir Presentes";
            Filtrar("SELECT * FROM convidados WHERE " + campo + " LIKE '" + toolStripTextBox2.Text + "%' " + filtro);
        }

        private void toolStripExibir_ButtonClick(object sender, EventArgs e)
        {
            Filtrar("SELECT * FROM convidados WHERE " + campo + " LIKE '" + toolStripTextBox2.Text + "%' " + filtro);
        }
